    ...
    while run:
        ...
        if key == ord(' ') or pause:
            ...
            while True:
                ...
                if (key == ord(' ') or pause) and count == 1:
                    pause = False
                    break
                if count == 0:
                    count += 1
                ...
                for id, lm in enumerate(handLms.landmark):
                    ...
                    if len(y) > 20:
                        ...
                        if not(x[0] > x[3] > x[4]) and (y[20] > y[17]):
                            right_wait += 1
                        if (x[0] > x[3] > x[4]) and (y[8] > y[5]) and (y[12] > y[9]) and (y[16] > y[13]) and (y[20] > y[17]):
                            stop_wait = True
                        if (x[0] > x[3] > x[4]) and (y[8] > y[5]) and not(y[12] > y[9]) and not(y[16] > y[13]) and (y[20] > y[17]):
                            love_condition = True
                            rotate_wait = 0
                        if (x[0] > x[3] > x[4]) and (y[20] > y[17]):
                            rotate_wait += 1
                        print("0 :", x[0], "4 :", x[4], "17 :", y[17], "20 :", y[20])
        ...
        if love_condition:
            ...
            if not pygame.mixer.music.get_busy():
                #D:/KKU_World/1_1/ComFair2023/pygame/AodAodEdit.mp3
                pygame.mixer.music.load('D:/KKU_World/1_1/ComFair2023/pygame/AodAodEdit.mp3')
                pygame.mixer.music.play()
            if left_wait >= 4 or right_wait >= 4:
                pass
